<?php
// 以下auth.phpから引用（Routeは重複しているから削除、pathも\Owner\を追加）
...
// Route::prefix("shops")とすることで、ルーティングの先頭に/shops/index/ , shops/edit/{shop}/ , /shops/update/{shop}とすることが可能
Route::prefix("shops")
    ->middleware("auth:owners") //必ずmiddleware()を経由してauth:ownersの確認をとる
