                    ...
                    <section class="text-gray-600 body-font">
                        <div class="container md:px-5 mx-auto">
                            ...
                            <div class="flex justify-end mb-4">
                                <button onClick="location.href='{{route("admin.owners.create")}}'" class="text-white bg-blue-500 border-0 py-2 px-8 focus:outline-none hover:bg-blue-600 rounded text-lg">
                                    新規登録する
                                </button>
                            </div>
                            ...
                            <table class="table-auto w-full text-left whitespace-no-wrap">
                                <thead>
                                <tr>
                                    <th class="md:px-4 py-3 title-font tracking-wider font-medium text-gray-900 text-sm bg-gray-100 rounded-tl rounded-bl">お名前</th>
                              ...
                              <tr>
                                ...
                                <td class="md:px-4 py-3">
                                    <button
                                        ...
                                        class="text-white bg-blue-400 border-0 py-2 px-4 focus:outline-none hover:bg-blue-500 rounded">
                                        編集する
                                    </button>
                                </td>
                                <form
