                        ...
                        @csrf
                                <div class="-m-2">
                                    ...
                                    <div class="p-2 w-1/2 mx-auto">
                                        <div class="relative">
                                            ...
                                            <input
                                                ...
                                                multiple
                                                name="files[][image]"
                                                {{-- 複数登録する場合のnameの書き方image[]でOKだが、バリデーションも実施するため、上記の様にfile[][image]と書く --}}
                                    ...
                                    <div class="p-2 w-full flex justify-around mt-4">
                                        <button type="button" onClick="location.href='{{route("owner.images.index")}}'" class="text-white bg-gray-300 border-0 py-2 px-8 focus:outline-none hover:bg-gray-400 rounded text-lg">
                                            戻る
                                        </button>
